...
key_secret = open("key_angel.txt","r").read().split()

obj=SmartConnect(api_key=key_secret[2])
data = obj.generateSession(key_secret[0],key_secret[1],TOTP(key_secret[3]).now())
